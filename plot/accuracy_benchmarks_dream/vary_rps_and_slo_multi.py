...
def file_hash(path: str) -> str:
    ...
    # use path name
    # use the date and time as the hash
    # path looks like ".../20251127/182647/..."
    date_time = re.search(r"(\d{8}/\d{6})", path)
    return date_time.group(1).replace("/", "_")
    # h = hashlib.sha1()
...
if __name__ == "__main__":
    ...
    plot_multi_benchmarks(
        ...
        save_path="system_compare_multi_dream.png",
    )
