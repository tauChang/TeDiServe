...
DEFAULT_SOURCE_FILE = Path(
    "/u/tchang85/dllm/plot/step_estimation_ablation/step_estimation_ablation_slo_acc_only_1x2.pdf"
)
DEFAULT_TARGET_FILE = Path(
    "/u/tchang85/tediserve_overleaf/figures/tediserve/step_predictor_slo_multiple.pdf"
)
