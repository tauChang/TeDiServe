...
DEFAULT_SOURCE_FILE = Path("/u/tchang85/dllm/plot/reconfig_ablation/reconfig_ablation.pdf")
DEFAULT_TARGET_FILE = Path("/u/tchang85/tediserve_overleaf/figures/eval/reconfig_ablation.pdf")
