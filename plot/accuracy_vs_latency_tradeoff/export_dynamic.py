...
DEFAULT_SOURCE_FILE = Path(
    "/u/tchang85/dllm/plot/accuracy_vs_latency_tradeoff/accuracy_vs_steps_dynamic.pdf"
)
DEFAULT_TARGET_FILE = Path(
    "/u/tchang85/tediserve_overleaf/figures/opportunities/accuracy_vs_steps_dynamic.pdf"
)
