...
DEFAULT_SOURCE_FILE = Path(
    "/u/tchang85/dllm/plot/step_estimation_slo_feature_ablation/step_estimation_slo_feature_ablation_1x2_twothirdscol.pdf"
)
DEFAULT_TARGET_FILE = Path(
    "/u/tchang85/tediserve_overleaf/figures/tediserve/"
    "step_predictor_slo_feature_ablation_twothirdscol.pdf"
)
