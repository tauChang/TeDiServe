...
DEFAULT_SOURCE_DIR = Path("/u/tchang85/dllm/plot/conf_adjustment_ablation")
DEFAULT_TARGET_DIR = Path("/u/tchang85/tediserve_overleaf/figures/eval")
FIGURE_BASENAMES = ["conf_adjustment_ablation"]
...
def main():
    ...
    parser.add_argument(
        ...
        help="Directory containing the confidence-adjustment ablation PNG or PDF.",
    )
    parser.add_argument(
        "--target-dir",
        type=Path,
