...
def main(summary_path: Path, output_dir: Path):
    ...
    plot_group_on_axis(
        ...
        tick_labels=["1.50", "1.75", "2.00", "2.25"],
    )
    ...
    axes[2, 0].set_ylim(0.68, 0.80)
    axes[2, 1].set_ylim(0.68, 0.80)
    axes[2, 0].set_yticks([0.70, 0.75, 0.80])
    axes[2, 1].set_yticks([0.70, 0.75, 0.80])
    ...
    legend_handles = [
        ...
        for k in ["oracle", "lightgbm_32", "lightgbm_1000"]
    ]
    fig.legend(
